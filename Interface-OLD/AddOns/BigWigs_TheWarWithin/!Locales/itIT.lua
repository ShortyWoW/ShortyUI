...
L = BigWigs:NewBossLocale("Reshanor, The Untethered", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Cauldron of Carnage", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Plexus Sentinel", "itIT")
if L then
...
L = BigWigs:NewBossLocale("Ulgrax the Devourer", "itIT")
if L then
