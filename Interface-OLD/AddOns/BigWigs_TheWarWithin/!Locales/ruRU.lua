...
L = BigWigs:NewBossLocale("Reshanor, The Untethered", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("Plexus Sentinel", "ruRU")
if L then
	--L.cleanse_the_chamber = "Wall"
end

L = BigWigs:NewBossLocale("Loom'ithar", "ruRU")
if L then
...
L = BigWigs:NewBossLocale("Ulgrax the Devourer", "ruRU")
if L then
