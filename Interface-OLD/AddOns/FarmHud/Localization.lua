...
L["AutoHide"] = "Automatically hide FarmHud"
L["BgAlphaDefault"] = "Main is default"
L["BgAlphaDefaultDesc"] = "Any time farmhud opened the main transparency will be set"
L["BgAlphaToggle"] = "Toggle transparency"
L["BgAlphaToggleDesc"] = "Switch between main and alternate transparency"
L["BgMinimap"] = "Minimap background (Topographic map)"
L["BgMinimapDesc"] = "The topographic map is an integral part of the minimap as a background. This background can be hidden by changing the transparency. In this section you can control the transparency more precisely."
L["BgTransparency1"] = "Main transparency"
L["BgTransparency2"] = "Alternative transparency"
L["BgTransparencyDesc1"] = "Main transparency of minimap background. Default 100%"
L["BgTransparencyDesc2"] = "Alternative transparency of minimap background. Default 50%"
...
L["CardinalPointsGatherCircleBind"] = "Bind to the gather circle"
L["CardinalPointsGatherCircleBindDesc"] = "Binds the cardinal points to the gather circle."
L["CardinalPointsGatherCircleDistance"] = "Distance to gather circle"
L["CardinalPointsGatherCircleDistanceDesc"] = "Choose the distance between the cardinal points and the gather circle."
L["CardinalPointsGatherCirclePos"] = "Position of cardinal points"
L["CardinalPointsGatherCirclePosDesc"] = "Choose position of the cardinal points inside or outside of the gather circle."
L["CardinalPointsGroup1"] = "N, W, S, E"
L["CardinalPointsGroup2"] = "NW, NE, SW, SE"
L["CardinalPointsInside"] = "Inside"
L["CardinalPointsOutside"] = "Outside"
...
L["hideInCombatDesc"] = "Automatically hides FarmHud at the start of combat and restores after combat ends."
L["HideInInstance"] = "Hide in instances"
L["HideInInstanceDesc"] = "Automatically hides FarmHud when entering an instance and restores it when leaving."
L["HudSize"] = "HUD Size"
...
L["PingLocationForbidden"] = "Sorry, ping on minimap is disabled after first use.|nThanks @ Blizzard for protected PingLocation."
...
L["PlayerDotNoLongerChangable"] = "Sorry, since patch 12.0.7, the player arrow can no longer be modified by addons."
...
L["RangeCircleDeleteDesc"] = "Delete the circle"
L["RangeCircleLineScale"] = "Line length"
L["RangeCircleLineScaleDesc"] = "Choose the length of the line. The circle is drawed by multiple lines to get a newly round circle. With this option you can change it into dashed or dotted circle line."
L["RangeCircleLineThickness"] = "Line thickness"
L["RangeCircleLineThicknessDesc"] = "Choose the thickness of the line"
L["RangeCircleNameDesc"] = "Change the name of the circle"
L["RangeCircles"] = "Range circles"
L["RangeCirclesDesc"] = "The new range circles based on lines instead of a single image that goes blurry on upscaling. :-)"
L["RangeCircleShowDesc"] = "Display the circle on opened FarmHud"
L["RangeCircleShowOnMinimap"] = "Show on minimap"
L["RangeCircleShowOnMinimapDesc"] = "Display the circle on minimap"
L["RangeCirclesWelcome"] = "Welcome to the new range circles"
L["RangeCircleYardsDesc"] = "Choose the circle radius in yards."
...
L["AutoHide"] = "FarmHud automatisch verstecken"
...
L["CardinalPointsGatherCircleBind"] = "An den Sammelkreis binden"
L["CardinalPointsGatherCircleBindDesc"] = "Bindet die Himmelsrichtungen an den Sammelkreis."
L["CardinalPointsGatherCircleDistance"] = "Abstand zum Sammelkreis"
L["CardinalPointsGatherCircleDistanceDesc"] = "Wähle den Abstand zwischen den Himmelsrichtungen und dem Sammelkreis an."
L["CardinalPointsGatherCirclePos"] = "Position der Himmelsrichtungen"
L["CardinalPointsGatherCirclePosDesc"] = "Wähle die Position der Himmelsrichtungen inner- oder ausserhalb des Sammelkreises."
L["CardinalPointsGroup1"] = "N, W, S, O"
L["CardinalPointsGroup2"] = "NW, NO, SW, SO"
L["CardinalPointsInside"] = "Innerhalb"
L["CardinalPointsOutside"] = "Ausserhalb"
...
L["hideInCombat"] = "Verstecke im Kampf"
L["hideInCombatDesc"] = "Blendet FarmHud zu Beginn des Kampfes automatisch aus und stellt es nach Ende des Kampfes wieder her."
L["HideInInstance"] = "Verstecken in Instanzen"
L["HideInInstanceDesc"] = "Blendet FarmHud beim Betreten einer Instanz automatisch aus und stellt es nach verlassen wieder her."
L["HudSize"] = "HUD Größe"
...
L["AddOnLoadedDesc"] = "Показывать сообщение 'Аддон загружен...' при входе в игру и перезагрузке интерфейса."
L["AddOnLoadedDescAlt"] = "Вы также можете удерживать Shift во время экрана загрузки, чтобы вывести это сообщение только для текущего сеанса."
L["AnotherAddOnsHijackedFunc"] = "Внимание: другой аддон перехватил важные функции. Список:"
L["AutoHide"] = "Автоматически скрывать FarmHud"
L["BgAlphaDefault"] = "Основная по умолчанию"
L["BgAlphaDefaultDesc"] = "При каждом открытии FarmHud будет устанавливаться основная прозрачность."
L["BgAlphaToggle"] = "Переключить прозрачность"
L["BgAlphaToggleDesc"] = "Переключение между основной и альтернативной прозрачностью."
L["BgMinimap"] = "Фон миникарты (топокарта)"
L["BgMinimapDesc"] = "Топографическая карта является частью фона миникарты. Этот фон можно скрыть, изменив прозрачность. В этом разделе вы можете настроить её точнее."
L["BgTransparency1"] = "Основная прозрачность"
L["BgTransparency2"] = "Альтернативная прозрачность"
L["BgTransparencyDesc1"] = "Основная прозрачность фона миникарты. По умолчанию 100%"
L["BgTransparencyDesc2"] = "Альтернативная прозрачность фона миникарты. По умолчанию 50%"
L["Black player dot"] = "Черная точка игрока"
L["Blizzards player arrow"] = "Стрелка игрока Blizzard"
L["Blizzards player arrow (smaller)"] = "Стрелка игрока Blizzard (меньше)"
L["CardinalPoints"] = "Стороны света"
L["CardinalPointsColorDesc"] = "Настроить цвет сторон света (%s)"
L["CardinalPointsColorResetDesc"] = "Сбросить цвет сторон света (%s)"
L["CardinalPointsGatherCircleBind"] = "Привязать к кругу сбора"
L["CardinalPointsGatherCircleBindDesc"] = "Привязывает обозначения сторон света к кругу сбора ресурсов."
L["CardinalPointsGatherCircleDistance"] = "Дистанция до круга сбора"
L["CardinalPointsGatherCircleDistanceDesc"] = "Выберите расстояние между сторонами света и кругом сбора."
L["CardinalPointsGatherCirclePos"] = "Позиция сторон света"
L["CardinalPointsGatherCirclePosDesc"] = "Выберите положение сторон света: внутри или снаружи круга сбора."
L["CardinalPointsGroup1"] = "С, З, Ю, В"
L["CardinalPointsGroup2"] = "СЗ, СВ, ЮЗ, ЮВ"
L["CardinalPointsInside"] = "Внутри"
L["CardinalPointsOutside"] = "Снаружи"
L["CardinalPointsShow"] = "Показать стороны света"
L["CardinalPointsShowDesc"] = "Отображать стороны света на HUD"
L["ChangeRadius"] = "Расстояние от центра"
L["ChangeRadiusDesc"] = "Изменить расстояние от центра на HUD"
L["Coords"] = "Координаты"
L["CoordsBottom"] = "Координаты снизу"
L["CoordsBottomDesc"] = "Отображать координаты игрока в нижней части"
L["CoordsColorDesc"] = "Настроить цвет координат"
L["CoordsColorResetDesc"] = "Сбросить цвет координат"
L["CoordsShow"] = "Показать координаты"
L["CoordsShowDesc"] = "Показывать координаты игрока на HUD"
L["DataBrokerOptions"] = "чтобы открыть настройки FarmHud"
L["DataBrokerToggle"] = "чтобы включить/выключить FarmHud"
L["DataBrokerToggleBackground"] = "чтобы переключить фон миникарты"
L["DebugOptFrames"] = "Вывод лишних элементов"
L["DebugOptFramesDesc"] = "Выводить список нежелательных элементов, привязанных к миникарте, если FarmHud включен."
L["DebugOptInfo"] = "Этот раздел содержит опции для поиска проблем совместимости с другими аддонами."
L["E"] = "В"
L["ExtraAddOnLoaded"] = "Дополнительный аддон '%s' включен!"
L["ExtraAddOnNotLoaded"] = "Для этой опции должен быть включен аддон '%s'!"
L["GatherCircle"] = "Круг сбора"
L["GatherCircleColorDesc"] = "Настроить цвет круга сбора"
L["GatherCircleDesc"] = "Круг сбора - это вспомогательная линия. Она показывает дистанцию вокруг вас, внутри которой все объекты (почтовые ящики, руда, трава) будут видны на миникарте и в FarmHud."
L["GatherCircleShow"] = "Показать круг сбора"
L["GatherCircleShowDesc"] = "Отображать круг сбора на HUD"
L["Golden player dot"] = "Золотая точка игрока"
L["HealCircle"] = "Круг радиуса исцеления"
L["HealcircleColorDesc"] = "Настроить цвет круга радиуса исцеления"
L["HealcircleDesc"] = "Круг радиуса исцеления - это вспомогательная линия. Она показывает дистанцию вокруг вас, в пределах которой вы можете лечить других игроков."
L["HealcircleShow"] = "Показать круг радиуса исцеления"
L["HealcircleShowDesc"] = "Отображать круг радиуса исцеления на HUD"
L["Hide player arrow"] = "Скрыть стрелку игрока"
L["hideInCombat"] = "Скрывать в бою"
L["hideInCombatDesc"] = "Автоматически скрывает FarmHud при начале боя и восстанавливает после его окончания."
L["HideInInstance"] = "Скрывать в подземельях"
L["HideInInstanceDesc"] = "Автоматически скрывает FarmHud при входе в подземелье/рейд и восстанавливает при выходе."
L["HudSize"] = "Размер HUD"
L["HudSizeDesc"] = "Устанавливает размер HUD в процентах от высоты экрана"
L["HudSymbolScale"] = "Масштаб символов HUD"
L["HudSymbolScaleDesc"] = "Масштабировать символы на HUD"
L["KeyBindBackground"] = "Переключить фон миникарты FarmHud"
L["KeyBindBackgroundDesc"] = "Назначить клавишу для отображения фона миникарты."
L["KeyBindMouse"] = "Переключить подсказки FarmHud (отключает клик сквозь Hud)"
L["KeyBindMouseDesc"] = "Назначить клавишу, позволяющую видеть подсказки при наведении на объекты (руда, трава, НИП выдающие задания) или кликать по hud для отправки пинга группе/рейду."
L["KeyBindToggle"] = "Переключить отображение FarmHud"
L["KeyBindToggleDesc"] = "Назначить клавишу для отображения FarmHud."
L["KnownProblematicAddOnDetected"] = "ВНИМАНИЕ: вы используете аддон, который мешает корректной работе FarmHud. Возможное решение: попробуйте скрыть мешающие элементы, отключив \"Показывать элементы\" в настройках FarmHud."
L["MinimapIcon"] = "Иконка у миникарты"
L["MinimapIconDesc"] = "Показывать кнопку у миникарты."
L["MouseOn"] = "МЫШЬ ВКЛ."
L["MouseOver"] = "Настройки наведения мыши"
L["MouseOverInfoColorDesc"] = "Настроить цвет текста 'МЫШЬ ВКЛ.' на HUD"
L["MouseOverOnHold"] = "Активация мышью при удержании клавиши"
L["MouseOverOnHoldDesc"] = "Включает режим взаимодействия с мышью только при удержании клавиши-модификатора (например, Alt)."
L["N"] = "С"
L["NE"] = "СВ"
L["NW"] = "СЗ"
L["OnScreen"] = "Экранные кнопки"
L["OnScreenAlphaDesc"] = "Настроить прозрачность экранных кнопок"
L["OnScreenBottom"] = "Экранные кнопки снизу"
L["OnScreenBottomDesc"] = "Отображать экранные кнопки в нижней части относительно центра HUD"
L["OnScreenShow"] = "Показать экранные кнопки"
L["OnScreenShowDesc"] = "Показывать экранные кнопки (режим \"мышь вкл.\", кнопка закрытия HUD и другие)"
L["PingLocationForbidden"] = "Извините, пинг по миникарте заблокирован после первого использования.|nСпасибо @ Blizzard за защиту функции PingLocation."
L["PlaceholderDesc"] = "Заполнитель - это элемент, который удерживает все видимые части миникарты на месте, пока активен FarmHud."
L["PlayerDot"] = "Стрелка или точка игрока"
L["PlayerDotDesc"] = "Изменить внешний вид вашей точки/стрелки на открытом HUD"
L["PleaseReportThisMessage"] = "Пожалуйста, сообщите об этом сообщении в разделе issues на CurseForge (скриншотом или текстом)."
L["QuestArrow"] = "Стрелка задания"
L["QuestArrowDesc"] = "Отображать стрелку задания на открытом HUD"
L["QuestArrowHide"] = "Скрыть стрелку задания на открытом HUD"
L["QuestArrowInfoMsg"] = "Информационное сообщение"
L["QuestArrowInfoMsgDesc"] = "Выводить информационное сообщение в общее окно чата"
L["QuestArrowInfoMsgDisabled"] = "Отслеживание заданий отключено"
L["QuestArrowInfoMsgRestored"] = "Отслеживание заданий восстановлено"
L["RangeCircleDeleteDesc"] = "Удалить круг"
L["RangeCircleLineScale"] = "Длина линии"
L["RangeCircleLineScaleDesc"] = "Выберите длину линии. Круг рисуется множеством отрезков для достижения округлости. С помощью этой опции можно сделать линию пунктирной."
L["RangeCircleLineThickness"] = "Толщина линии"
L["RangeCircleLineThicknessDesc"] = "Выберите толщину линии"
L["RangeCircleNameDesc"] = "Изменить название круга"
L["RangeCircles"] = "Круги радиуса"
L["RangeCirclesDesc"] = "Новые круги радиуса отрисовываются линиями, а не картинкой, которая размывается при масштабировании. :-)"
L["RangeCircleShowDesc"] = "Отображать круг на открытом FarmHud"
L["RangeCircleShowOnMinimap"] = "Показывать на миникарте"
L["RangeCircleShowOnMinimapDesc"] = "Отображать круг на обычной миникарте"
L["RangeCirclesWelcome"] = "Добро пожаловать в настройки новых кругов радиуса"
L["RangeCircleYardsDesc"] = "Выберите радиус круга в ярдах."
L["ResetColor"] = "Сбросить цвет"
L["Rotation"] = "Вращение"
L["RotationDesc"] = "Принудительно включить вращение миникарты в режиме HUD"
L["S"] = "Ю"
L["SE"] = "ЮВ"
L["ShowPlaceholder"] = "Показывать элементы"
L["ShowPlaceholderBg"] = "Показывать фон"
L["ShowPlaceholderBgDesc"] = "Отображать черный фон вместо миникарты, пока активен FarmHud."
L["ShowPlaceholderDesc"] = "Элементы вашей миникарты останутся видимыми, даже когда FarmHud активен."
L["SupportBlizzard"] = "Blizzard внесли изменения, из-за которых поддержка отдельных аддонов или библиотек стала неэффективной."
L["SupportHereBeDragon"] = "TomTom и HandyNotes поддерживаются через библиотеку HereBeDragon, но у HandyNotes есть проблема с переключением HUD. Все иконки вокруг вас исчезают при включении FarmHud, но должны появиться снова, если немного пройтись или пролететь рядом."
L["SupportOptions"] = "Настройки поддержки"
L["SW"] = "ЮЗ"
L["TextScale"] = "Масштаб текста"
L["TextScaleDesc"] = "Масштаб текста для сторон света, надписи \"мышь вкл.\" и координат на HUD"
L["Time"] = "Серверное/Местное время"
L["TimeBottom"] = "Время снизу"
L["TimeBottomDesc"] = "Отображать время в нижней части"
L["TimeColorDesc"] = "Настроить цвет времени"
L["TimeColorResetDesc"] = "Сбросить цвет времени"
L["TimeLocal"] = "Местное время"
L["TimeLocalDesc"] = "Отображать местное время."
L["TimeServer"] = "Серверное время"
L["TimeServerDesc"] = "Отображать серверное время."
L["TimeShow"] = "Показать время"
L["TimeShowDesc"] = "Отображать серверное или местное время в режиме HUD"
L["TrackingOptions"] = "Настройки отслеживания"
L["TrackingOptionsDesc"] = "Переключить иконки отслеживания на открытом FarmHud.|n|n\"Как на миникарте\" означает, что будут использоваться ваши текущие настройки кнопки отслеживания у миникарты."
L["TrackingOptionsLikeMinimap"] = "Как на миникарте"
L["TrailPath"] = "След"
L["TrailPathColorsDesc"] = "Настроить цвет иконок следа"
L["TrailPathCount"] = "Количество точек"
L["TrailPathCountDesc"] = "Настроить макс. количество отпечатков на миникарте/FarmHud."
L["TrailPathIcon"] = "Иконка"
L["TrailPathIconDesc"] = "Выберите иконку для ваших следов."
L["TrailPathOnMinimap"] = "Показывать на миникарте"
L["TrailPathOnMinimapDesc"] = "Отображать след также и на обычной миникарте."
L["TrailPathScale"] = "Масштаб иконки"
L["TrailPathScaleDesc"] = "Настроить размер ваших следов."
L["TrailPathShow"] = "Показывать след"
L["TrailPathTimeout"] = "Время исчезновения (сек.)"
L["TrailPathTimeoutDesc"] = "Настройте время, через которое ваши следы будут удалены с миникарты/FarmHud."
L["W"] = "З"
L["White player dot"] = "Белая точка игрока"

elseif LOCALE_zhCN then
L["AddOnLoaded"] = "插件已加载......"
L["AddOnLoadedDesc"] = "在登录和界面加载时显示“插件已加载”的提示信息。"
L["AddOnLoadedDescAlt"] = "你也可以在加载界面时按住Shift键来临时显示此信息。"
L["AnotherAddOnsHijackedFunc"] = "警告：另一个插件劫持了一些基本函数。请参阅以下列表："
L["AutoHide"] = "自动隐藏"
L["BgAlphaDefault"] = "主透明度为默认"
L["BgAlphaDefaultDesc"] = "任何时间打开farmhud，主透明度将被设置"
L["BgAlphaToggle"] = "切换透明度"
L["BgAlphaToggleDesc"] = "在主要和备用透明度之间切换"
L["BgMinimap"] = "小地图背景（地形图）"
L["BgMinimapDesc"] = "地形图是小地图的作为背景的一部分。这个背景可以通过改变透明度来隐藏。在这一部分，您可以更精确地控制透明度。"
L["BgTransparency1"] = "主透明度"
L["BgTransparency2"] = "备用透明度"
L["BgTransparencyDesc1"] = "小地图背景的主要透明度。默认为100%"
L["BgTransparencyDesc2"] = "小地图背景的备用透明度。默认为50%"
L["Black player dot"] = "玩家黑圆点"
L["Blizzards player arrow"] = "暴雪式玩家箭头"
L["Blizzards player arrow (smaller)"] = "暴雪式玩家箭头（较小）"
L["CardinalPoints"] = "方位"
L["CardinalPointsColorDesc"] = "调整方位的文字颜色(%s)"
L["CardinalPointsColorResetDesc"] = "重置方位的文字颜色(%s)"
L["CardinalPointsGatherCircleBind"] = "绑定到采集指示圈"
L["CardinalPointsGatherCircleBindDesc"] = "将方位与采集指示圈绑定。"
L["CardinalPointsGatherCircleDistance"] = "到采集指示圈的距离"
L["CardinalPointsGatherCircleDistanceDesc"] = "选择方位和采集指示圈之间的距离。"
L["CardinalPointsGatherCirclePos"] = "采集指示圈的位置"
L["CardinalPointsGatherCirclePosDesc"] = "选择方位在采集指示圈的位置在内部或外部。"
L["CardinalPointsGroup1"] = "北, 西, 南, 东"
L["CardinalPointsGroup2"] = "西北, 东北, 西南, 东南"
L["CardinalPointsInside"] = "内部"
L["CardinalPointsOutside"] = "外部"
L["CardinalPointsShow"] = "显示方位"
L["CardinalPointsShowDesc"] = "在 HUD 中显示方位"
L["ChangeRadius"] = "距中心的距离"
L["ChangeRadiusDesc"] = "更改距 HUD 中心的距离"
L["Coords"] = "坐标"
L["CoordsBottom"] = "底部坐标"
...
L["DataBrokerToggle"] = "开关 FarmHud"
L["DataBrokerToggleBackground"] = "开关小地图背景"
L["DebugOptFrames"] = "打印出不需要的元素"
L["DebugOptFramesDesc"] = "在 FarmHud 启用时打印出小地图上锚定的不需要的元素的列表"
L["DebugOptInfo"] = "此部分包含帮助其他插件追踪问题的选项。"
L["E"] = "东"
...
L["HealcircleShowDesc"] = "在 HUD 上显示治疗范围指示圈"
L["Hide player arrow"] = "隐藏玩家箭头"
L["hideInCombat"] = "战斗中隐藏"
L["hideInCombatDesc"] = "在战斗开始时自动隐藏 FarmHud，并在战斗结束后恢复。"
L["HideInInstance"] = "副本中隐藏"
L["HideInInstanceDesc"] = "进入副本时自动隐藏 FarmHud，离开时恢复。"
L["HudSize"] = "HUD 尺寸"
L["HudSizeDesc"] = "将 HUD 尺寸设置为屏幕高度的百分比"
L["HudSymbolScale"] = "HUD 符号比例"
L["HudSymbolScaleDesc"] = "缩放 HUD 上的符号"
L["KeyBindBackground"] = "开关 FarmHud 的小地图背景"
L["KeyBindBackgroundDesc"] = "设置按键绑定以显示小地图背景。"
L["KeyBindMouse"] = "开关 FarmHud 的鼠标提示（无法透过 Hud 点击）"
L["KeyBindMouseDesc"] = "设置按键绑定以允许将鼠标悬停在感兴趣点节点（如矿石、草药或任务提供者）的鼠标提示上。 或者单击 HUD 向你的小队或团队发送信号标记。"
L["KeyBindToggle"] = "开关 FarmHud 的显示"
L["KeyBindToggleDesc"] = "设置按键绑定以显示 FarmHud。"
L["KnownProblematicAddOnDetected"] = "警告：您正在使用的插件会导致其与 FarmHud 的顺利合作变得困难。 可能的解决方法：您可以尝试隐藏干扰元素。 在 FarmHud 选项中禁用“显示元素”。"
L["MinimapIcon"] = "微缩地图按钮"
L["MinimapIconDesc"] = "显示微缩地图按钮。"
L["MouseOn"] = "鼠标悬停开启"
L["MouseOver"] = "鼠标悬停选项"
L["MouseOverInfoColorDesc"] = "调整 HUD 上的文本“鼠标悬停开启”的颜色"
L["MouseOverOnHold"] = "按住修饰键时鼠标悬停"
L["MouseOverOnHoldDesc"] = "这是一个选项，用于在您按住修饰键（如Alt键）时启用鼠标悬停模式"
L["N"] = "北"
L["NE"] = "东北"
L["NW"] = "西北"
L["OnScreen"] = "屏幕按钮"
L["OnScreenAlphaDesc"] = "调整屏幕按钮的透明度"
L["OnScreenBottom"] = "底部屏幕按钮"
L["OnScreenBottomDesc"] = "在 HUD 中间底部显示屏幕按钮"
L["OnScreenShow"] = "显示屏幕按钮"
L["OnScreenShowDesc"] = "显示屏幕按钮（“鼠标悬停开启”模式、HUD关闭按钮等）"
L["PlaceholderDesc"] = "占位符是一个元素，用于在 Farmhud 启用时固定你的小地图上所有可见元素。"
L["PlayerDot"] = "玩家箭头或圆点"
L["PlayerDotDesc"] = "更改打开的 FarmHud 上玩家圆点/箭头的外观"
L["PleaseReportThisMessage"] = "请以屏幕截图或文本形式到 curseforge 网站上的问题页面报告此信息。"
L["QuestArrow"] = "任务箭头"
L["QuestArrowDesc"] = "在 HUD 上显示任务箭头"
L["QuestArrowHide"] = "隐藏 HUD 上的任务箭头"
L["QuestArrowInfoMsg"] = "显示详情信息"
L["QuestArrowInfoMsgDesc"] = "在常规聊天窗口中显示详情信息"
L["QuestArrowInfoMsgDisabled"] = "任务追踪已禁用"
L["QuestArrowInfoMsgRestored"] = "任务追踪已恢复"
L["RangeCircleDeleteDesc"] = "删除指示圈"
L["RangeCircleLineScale"] = "线长度"
L["RangeCircleLineScaleDesc"] = "选择线的长度。圆是由多条线绘制而成，以得到一个新的圆形。通过这个选项，你可以将其更改为虚线或点划线。"
L["RangeCircleLineThickness"] = "线厚度"
L["RangeCircleLineThicknessDesc"] = "选择线的粗细"
L["RangeCircleNameDesc"] = "修改指示圈的名称"
L["RangeCircles"] = "范围指示圈"
L["RangeCirclesDesc"] = "新的范围指示圈基于线条进行绘制，而不是基于在放大时会变得模糊的单个图片。:-)"
L["RangeCircleShowDesc"] = "显示 FarmHud 上显示范围指示圈"
L["RangeCircleShowOnMinimap"] = "在小地图上显示"
L["RangeCircleShowOnMinimapDesc"] = "在小地图上显示范围指示圈"
L["RangeCirclesWelcome"] = "欢迎使用新的范围指示圈"
L["RangeCircleYardsDesc"] = "请以码为单位，选择范围指示圈的半径。"
L["ResetColor"] = "重置颜色"
L["Rotation"] = "旋转"
...
L["ShowPlaceholderBgDesc"] = "当 FarmHud 处于激活状态时，显示黑色背景而不是小地图。"
L["ShowPlaceholderDesc"] = "即使 FarmHud 处于激活状态，你的小地图的元素仍然可见。"
L["SupportBlizzard"] = "暴雪做了一些改变使得提供单个插件或库的可选支持变得毫无意义。"
L["SupportHereBeDragon"] = "Tomtom 和 HandyNotes 通过 HereBeDragon 库得到支持，但 HandyNotes 在 Hud 切换方面存在问题。 通过开关 FarmHud，您周围的所有图标都会消失。 但经过一点点步行/飞行应该能再次显示。"
L["SupportOptions"] = "支持选项"
L["SW"] = "西南"
L["TextScale"] = "文字缩放"
L["TextScaleDesc"] = "HUD 上显示的“方位”、“鼠标悬停开启”和“坐标”的文字缩放"
L["Time"] = "时间"
L["TimeBottom"] = "底部显示时间"
L["TimeBottomDesc"] = "在底部显示时间"
L["TimeColorDesc"] = "调整时间的颜色"
...
L["TrailPath"] = "路径轨迹"
L["TrailPathColorsDesc"] = "调整路径轨迹图标的颜色"
L["TrailPathCount"] = "轨迹点数"
L["TrailPathCountDesc"] = "调整小地图或 farmhud 上的轨迹点的最大点数。"
L["TrailPathIcon"] = "轨迹图标"
L["TrailPathIconDesc"] = "为你的轨迹点选择一个图标。"
L["TrailPathOnMinimap"] = "在小地图上显示"
L["TrailPathOnMinimapDesc"] = "也在小地图上显示路径轨迹"
L["TrailPathScale"] = "图标缩放"
L["TrailPathScaleDesc"] = "调整轨迹点的大小"
L["TrailPathShow"] = "显示路径轨迹"
L["TrailPathTimeout"] = "淡出（单位：秒）"
L["TrailPathTimeoutDesc"] = "调整从小地图或 farmhud 中删除轨迹点的时间。"
L["W"] = "西"
L["White player dot"] = "玩家白圆点"

elseif LOCALE_zhTW then
L["AddOnLoaded"] = "插件已載入..."
L["AddOnLoadedDesc"] = "在登入和重載UI後顯示  '插件已載入...' 的訊息."
L["AddOnLoadedDescAlt"] = "你也可以在讀取畫面時按住 shift 鍵來僅在此次登入顯示此訊息."
L["AnotherAddOnsHijackedFunc"] = "警告: 有些插件劫持了一些必要的函式. 請查看以下清單:"
L["Black player dot"] = "黑色圓點"
L["Blizzards player arrow"] = "暴雪式角色箭頭"
L["Blizzards player arrow (smaller)"] = "暴雪式角色箭頭 (較小)"
L["CardinalPoints"] = "方位"
L["CardinalPointsColorDesc"] = "調整方位文字的顏色 (%s)"
L["CardinalPointsColorResetDesc"] = "重置方位文字的顏色 (%s)"
L["CardinalPointsGroup1"] = "北, 西, 南, 東"
L["CardinalPointsGroup2"] = "西北, 東北, 西南, 東南"
L["CardinalPointsShow"] = "顯示方位"
L["CardinalPointsShowDesc"] = "在抬頭顯示器上顯示方位文字"
L["ChangeRadius"] = "與中心距離"
L["ChangeRadiusDesc"] = "改變與抬頭顯示器中心的距離"
L["Coords"] = "座標"
L["CoordsBottom"] = "底部座標"
...
L["CoordsShow"] = "顯示座標"
L["CoordsShowDesc"] = "在抬頭顯示器上顯示座標"
L["DataBrokerOptions"] = "打開農夫雷達選項"
L["DataBrokerToggle"] = "打開農夫雷達"
L["DataBrokerToggleBackground"] = "打開小地圖背景"
L["DebugOptFrames"] = "印出不想要元素"
L["DebugOptFramesDesc"] = "在農夫雷達啟用時印出錨定在小地圖上的不想要元素."
L["DebugOptInfo"] = "此部分包含了幫助與其他插件追蹤問題的選項."
L["E"] = "東"
L["ExtraAddOnLoaded"] = "額外插件 '%s' 已載入!"
L["ExtraAddOnNotLoaded"] = "對於此選項額外插件 '%s' 必須被啟用!"
L["GatherCircle"] = "採集圈圈"
L["GatherCircleColorDesc"] = "調整採集圈圈的顏色"
L["GatherCircleDesc"] = "採集圈圈是種視覺輔助線. 它代表了所有興趣點 (信箱, 礦石, 草藥) 與你的位置會在小地圖和農夫雷達上顯示的距離."
L["GatherCircleShow"] = "顯示採集圈圈"
L["GatherCircleShowDesc"] = "在抬頭顯示器上顯示採集圈圈"
L["Golden player dot"] = "金色圓點"
L["HealCircle"] = "治療圈圈"
L["HealcircleColorDesc"] = "調整治療圈圈的顏色"
L["HealcircleDesc"] = "治療圈圈是種視覺輔助線. 它代表了你的位置可以治療到其他玩家的距離."
L["HealcircleShow"] = "顯示治療圈圈"
L["HealcircleShowDesc"] = "在抬頭顯示器上顯示治療圈圈"
L["Hide player arrow"] = "隱藏玩家箭頭"
L["HudSize"] = "抬頭顯示器大小"
L["HudSizeDesc"] = "設定抬頭顯示器的大小到螢幕高度的百分比"
L["HudSymbolScale"] = "抬頭顯示器圖標縮放"
L["HudSymbolScaleDesc"] = "縮放抬頭顯上器上的圖標大小"
L["KeyBindBackground"] = "切換農夫雷達的小地圖背景"
L["KeyBindBackgroundDesc"] = "設定顯示小地圖背景的快捷鍵."
L["KeyBindMouse"] = "切換農夫雷達滑鼠提示 (會無法點選抬頭顯示器後面的東西)"
L["KeyBindMouseDesc"] = "設定熱鍵來允許在抬頭顯示器上懸停興趣點時 (例如 礦石, 草藥, 任務提供者) 顯示滑鼠提示. 或是在抬頭顯示器上標點給你的隊伍或團隊."
L["KeyBindToggle"] = "切換顯示農夫雷達"
L["KeyBindToggleDesc"] = "設定快捷鍵來顯示農夫雷達"
L["KnownProblematicAddOnDetected"] = "警告: 你正在使用難以和農夫雷達共同使用的插件. 可能的解決方法: 你可以嘗試隱藏惱人的元素.在農夫雷達選項中停用 \"顯示元素\"."
L["MinimapIcon"] = "小地圖圖示"
L["MinimapIconDesc"] = "顯示小地圖圖示"
L["MouseOn"] = "滑鼠懸停開啟"
L["MouseOver"] = "滑鼠懸停選項"
L["MouseOverInfoColorDesc"] = "調整抬頭顯示器上 '滑鼠懸停開啟' 文字的顏色"
L["MouseOverOnHold"] = "滑鼠懸停組合鍵"
L["MouseOverOnHoldDesc"] = "此選項會在你按住組合鍵 (如Alt) 時啟用滑鼠懸停模式"
L["N"] = "北"
L["NE"] = "東北"
L["NW"] = "西北"
L["OnScreen"] = "螢幕上按紐"
L["OnScreenAlphaDesc"] = "調整螢幕上按鈕的透明度"
L["OnScreenBottom"] = "在底部顯示螢幕上按紐"
L["OnScreenBottomDesc"] = "在抬頭顯示器中間下方顯示螢幕上按紐"
L["OnScreenShow"] = "顯示螢幕上按紐"
L["OnScreenShowDesc"] = "顯示ˇ螢幕上按紐 (\"滑鼠懸停\" 模式, 關閉抬頭顯示器按鈕等等)"
L["PlaceholderDesc"] = "暫存元件是當農夫雷達啟用時用來保留你原本小地圖上可見元件的暫時元件."
L["PlayerDot"] = "玩家箭頭或圓點"
L["PlayerDotDesc"] = "改變當開啟農夫雷達時顯示的玩家箭頭或圓點"
L["PleaseReportThisMessage"] = "請用截圖或文字回報此訊息到 curseforge 網站上的 issues."
L["QuestArrow"] = "任務箭頭"
L["QuestArrowDesc"] = "在抬頭顯示器上顯示任務箭頭"
L["QuestArrowHide"] = "在抬頭顯示器上隱藏任務箭頭"
L["QuestArrowInfoMsg"] = "顯示資訊訊息"
L["QuestArrowInfoMsgDesc"] = "在聊天視窗顯示資訊訊息"
L["QuestArrowInfoMsgDisabled"] = "任務追蹤已停用"
L["QuestArrowInfoMsgRestored"] = "任務追蹤已回復"
L["RangeCircles"] = "距離圈圈"
L["ResetColor"] = "重置顏色"
L["Rotation"] = "小地圖旋轉"
L["RotationDesc"] = "在抬頭顯示器模式時強制啟用小地圖旋轉"
L["S"] = "南"
L["SE"] = "東南"
L["ShowPlaceholder"] = "顯示元素"
L["ShowPlaceholderBg"] = "顯示背景"
L["ShowPlaceholderBgDesc"] = "當農夫雷達啟用時在小地圖位置顯示一個黑色背景"
L["ShowPlaceholderDesc"] = "當農夫雷達啟用時仍然顯示你的小地圖元素"
L["SupportBlizzard"] = "暴雪做出了一些改變使得對於插件或是函式庫的可選支持變成無用的."
L["SupportHereBeDragon"] = "Tomtom 和 HandyNotes 透過凾式庫 HereBeDragon 已被支援. 但是在切換抬頭顯示器時 HandyNotes 會發生一個問題. 所有在你位置附近的圖標會消失. 但是在移動或飛行一陣子後應該會再次顯示."
L["SupportOptions"] = "支援選項"
L["SW"] = "西南"
L["TextScale"] = "文字縮放"
L["TextScaleDesc"] = "抬頭顯示器上的方位, 座標, 提示文字的縮放"
L["Time"] = "伺服器/本地 時間"
L["TimeBottom"] = "在底部顯示時間"
L["TimeBottomDesc"] = "在底部顯示時間"
L["TimeColorDesc"] = "調整時間顏色"
L["TimeColorResetDesc"] = "重置時間顏色"
L["TimeLocal"] = "本地時間"
L["TimeLocalDesc"] = "顯示本地時間."
L["TimeServer"] = "伺服器時間"
L["TimeServerDesc"] = "顯示伺服器時間"
L["TimeShow"] = "顯示時間"
L["TimeShowDesc"] = "在抬頭顯示器顯示伺服器或是本地時間"
L["TrackingOptions"] = "追蹤選項"
L["TrackingOptionsDesc"] = "切換開啟農夫雷達時追蹤的圖標.|n|n\"和小地圖相同\" 表示會開啟農夫雷達時會使用你小地圖追蹤時的設定."
L["TrackingOptionsLikeMinimap"] = "和小地圖相同"
L["TrailPath"] = "路徑軌跡"
L["TrailPathColorsDesc"] = "調整路徑軌跡圖標的顏色"
L["TrailPathCount"] = "軌跡數量"
L["TrailPathCountDesc"] = "調整在 小地圖/農夫雷達 上足跡的最大值"
L["TrailPathIcon"] = "圖示"
L["TrailPathIconDesc"] = "選擇一個代表你足跡的圖示"
L["TrailPathOnMinimap"] = "在小地圖上顯示"
L["TrailPathOnMinimapDesc"] = "在小地圖上也顯示軌跡."
L["TrailPathScale"] = "軌跡縮放"
L["TrailPathScaleDesc"] = "調整你足跡的大小."
L["TrailPathShow"] = "顯示路徑軌跡"
L["TrailPathTimeout"] = "消失 (秒.)"
L["TrailPathTimeoutDesc"] = "調整你的足跡在小地圖或農夫雷達上存在的時間."
L["W"] = "西"
L["White player dot"] = "白色圓點"
