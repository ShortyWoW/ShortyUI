...
local provider = {region='US',realm='Archimonde',name='US',type='subscribers',zone=46,date='2026-06-19',data={As='Aspir:BAEALgAECggJCAABLgAFFAcJGAABAEkWAA==.',Da='Daddio:BAEALgADCgIJAwABLgADCgcJBwACAAAAAA==.',Li='Linthori:BAEALgADCgMJAwABLgAECgcJDQACAAAAAA==.',Ne='Nelson:BAEALgAECgYJCAABLgAECgkJLQADAFEeAA==.',Or='Ori:BAEALgADCgcJCwABLgAECgcJDQACAAAAAA==.',Ph='Philsner:BAEALgAECgcJDQAAAA==.',},}
