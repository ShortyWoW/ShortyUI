...
elseif Private.IsMists then
    ...
    L["addon.parse-gate-description"] = "Parses shown after 10H kills"
    L["Encounter-101577"] = [[Jin'rokh the Breaker]]
    L["Encounter-101575"] = [[Horridon]]
    L["Encounter-101570"] = [[Council of Elders]]
    L["Encounter-101565"] = [[Tortos]]
    L["Encounter-101578"] = [[Megaera]]
    L["Encounter-101573"] = [[Ji-Kun]]
    L["Encounter-101572"] = [[Durumu the Forgotten]]
    L["Encounter-101574"] = [[Primordius]]
    L["Encounter-101576"] = [[Dark Animus]]
    L["Encounter-101559"] = [[Iron Qon]]
    L["Encounter-101560"] = [[Twin Empyreans]]
    L["Encounter-101579"] = [[Lei Shen]]
    L["Encounter-101580"] = [[Ra-den]]
...
elseif C_Seasons.GetActiveSeason() == 109 then
    L["addon.parse-gate-description"] = "Parses shown after 10H kills"
    L["Encounter-100629"] = [[Northrend Beasts]]
    L["Encounter-100633"] = [[Lord Jaraxxus]]
    L["Encounter-100637"] = [[Faction Champions]]
    L["Encounter-100641"] = [[Val'kyr Twins]]
    L["Encounter-100645"] = [[Anub'arak]]
    L["Encounter-200784"] = [[High Priest Venoxis]]
    L["Encounter-200785"] = [[High Priestess Jeklik]]
    L["Encounter-200786"] = [[High Priestess Mar'li]]
    L["Encounter-200787"] = [[Bloodlord Mandokir]]
    L["Encounter-200788"] = [[Edge of Madness]]
    L["Encounter-200789"] = [[High Priest Thekal]]
    L["Encounter-200790"] = [[Gahz'ranka]]
    L["Encounter-200791"] = [[High Priestess Arlokk]]
    L["Encounter-200792"] = [[Jin'do the Hexxer]]
    L["Encounter-200793"] = [[Hakkar]]
...
if locale == "deDE" then
    ...
    elseif Private.IsMists then
        ...
        L["Encounter-51580"] = [[Ra-den]]
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-101577"] = [[Jin'rokh der Zerstörer]]
        L["Encounter-101575"] = [[Horridon]]
        L["Encounter-101570"] = [[Rat der Ältesten]]
        L["Encounter-101565"] = [[Tortos]]
        L["Encounter-101578"] = [[Megaera]]
        L["Encounter-101573"] = [[Ji-Kun]]
        L["Encounter-101572"] = [[Durumu der Vergessene]]
        L["Encounter-101574"] = [[Primordius]]
        L["Encounter-101576"] = [[Dunkler Animus]]
        L["Encounter-101559"] = [[Der eiserne Qon]]
        L["Encounter-101560"] = [[Zwillingsempyreanerinnen]]
        L["Encounter-101579"] = [[Lei Shen]]
        L["Encounter-101580"] = [[Ra-den]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-100629"] = [[Bestien von Nordend]]
        L["Encounter-100633"] = [[Lord Jaraxxus]]
        L["Encounter-100637"] = [[Fraktionschampions]]
        L["Encounter-100641"] = [[Zwillingsval'kyr]]
        L["Encounter-100645"] = [[Anub'arak]]
        L["Encounter-200784"] = [[Hohepriester Venoxis]]
        L["Encounter-200785"] = [[Hohepriesterin Jeklik]]
        L["Encounter-200786"] = [[Hohepriesterin Mar'li]]
        L["Encounter-200787"] = [[Blutfürst Mandokir]]
        L["Encounter-200788"] = [[Rand des Wahnsinns]]
        L["Encounter-200789"] = [[Hohepriester Thekal]]
        L["Encounter-200790"] = [[Gahz'ranka]]
        L["Encounter-200791"] = [[Hohepriesterin Arlokk]]
        L["Encounter-200792"] = [[Jin'do der Verhexer]]
        L["Encounter-200793"] = [[Hakkar]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
...
elseif locale == "esES" or locale == "esMX" then
    ...
    elseif Private.IsMists then
        ...
        L["Encounter-51580"] = [[Ra Den]]
        L["addon.parse-gate-description"] = "Parses mostrados tras 10H muertes"
        L["Encounter-101577"] = [[Jin'rokh el Rompedor]]
        L["Encounter-101575"] = [[Horridonte]]
        L["Encounter-101570"] = [[Consejo de Ancianos]]
        L["Encounter-101565"] = [[Tortos]]
        L["Encounter-101578"] = [[Megaera]]
        L["Encounter-101573"] = [[Ji Kun]]
        L["Encounter-101572"] = [[Durumu el Olvidado]]
        L["Encounter-101574"] = [[Primordius]]
        L["Encounter-101576"] = [[Animus oscuro]]
        L["Encounter-101559"] = [[Qon el Tenaz]]
        L["Encounter-101560"] = [[Empíreas Gemelas]]
        L["Encounter-101579"] = [[Lei Shen]]
        L["Encounter-101580"] = [[Ra Den]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "Parses mostrados tras 10H muertes"
        L["Encounter-100629"] = [[Bestias de Rasganorte]]
        L["Encounter-100633"] = [[Lord Jaraxxus]]
        L["Encounter-100637"] = [[Campeones de la facción]]
        L["Encounter-100641"] = [[Gemelas Val'kyr]]
        L["Encounter-100645"] = [[Anub'arak]]
        L["Encounter-200784"] = [[Sumo sacerdote Venoxis]]
        L["Encounter-200785"] = [[Suma sacerdotisa Jeklik]]
        L["Encounter-200786"] = [[Suma sacerdotisa Mar'li]]
        L["Encounter-200787"] = [[Señor sangriento Mandokir]]
        L["Encounter-200788"] = [[Cabo de la Locura]]
        L["Encounter-200789"] = [[Sumo sacerdote Thekal]]
        L["Encounter-200790"] = [[Gahz'ranka]]
        L["Encounter-200791"] = [[Suma sacerdotisa Arlokk]]
        L["Encounter-200792"] = [[Jin'do el Aojador]]
        L["Encounter-200793"] = [[Hakkar]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "Parses mostrados tras 10H muertes"
...
elseif locale == "frFR" then
    ...
    elseif Private.IsMists then
        ...
        L["Encounter-51580"] = [[Ra Den]]
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-101577"] = [[Jin’rokh le Briseur]]
        L["Encounter-101575"] = [[Horridon]]
        L["Encounter-101570"] = [[Conseil des anciens]]
        L["Encounter-101565"] = [[Tortos]]
        L["Encounter-101578"] = [[Megaera]]
        L["Encounter-101573"] = [[Ji Kun]]
        L["Encounter-101572"] = [[Durumu l’Oublié]]
        L["Encounter-101574"] = [[Primordius]]
        L["Encounter-101576"] = [[Sombre animus]]
        L["Encounter-101559"] = [[Qwon de fer]]
        L["Encounter-101560"] = [[Jumelles empyréennes]]
        L["Encounter-101579"] = [[Lei Shen]]
        L["Encounter-101580"] = [[Ra Den]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-100629"] = [[Bêtes du Norfendre]]
        L["Encounter-100633"] = [[Seigneur Jaraxxus]]
        L["Encounter-100637"] = [[Champions de faction]]
        L["Encounter-100641"] = [[Jumelles val’kyrs]]
        L["Encounter-100645"] = [[Anub’arak]]
        L["Encounter-200784"] = [[Grand prêtre Venoxis]]
        L["Encounter-200785"] = [[Grande prêtresse Jeklik]]
        L["Encounter-200786"] = [[Grande prêtresse Mar'li]]
        L["Encounter-200787"] = [[Seigneur sanglant Mandokir]]
        L["Encounter-200788"] = [[Frontière de la folie]]
        L["Encounter-200789"] = [[Grand prêtre Thekal]]
        L["Encounter-200790"] = [[Gahz'ranka]]
        L["Encounter-200791"] = [[Grande prêtresse Arlokk]]
        L["Encounter-200792"] = [[Jin'do le Maléficieur]]
        L["Encounter-200793"] = [[Hakkar]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
...
elseif locale == "itIT" then
    ...
    elseif Private.IsMists then
        ...
        L["Encounter-51580"] = [[Ra-Den]]
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-101577"] = [[Jin'rokh il Demolitore]]
        L["Encounter-101575"] = [[Horridon]]
        L["Encounter-101570"] = [[Concilio degli Anziani]]
        L["Encounter-101565"] = [[Tortos]]
        L["Encounter-101578"] = [[Megaera]]
        L["Encounter-101573"] = [[Ji-Kun]]
        L["Encounter-101572"] = [[Durumu il Dimenticato]]
        L["Encounter-101574"] = [[Primordius]]
        L["Encounter-101576"] = [[Animus Oscuro]]
        L["Encounter-101559"] = [[Qon il Tenace]]
        L["Encounter-101560"] = [[Empiree Gemelle]]
        L["Encounter-101579"] = [[Lei Shen]]
        L["Encounter-101580"] = [[Ra-Den]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        ...
        L["Encounter-100641"] = [[Val'kyr Twins]]
        L["Encounter-100645"] = [[Anub'arak]]
        L["Encounter-200784"] = [[Gran Sacerdote Venoxis]]
        L["Encounter-200785"] = [[Gran Sacerdotessa Jeklik]]
        L["Encounter-200786"] = [[Gran Sacerdotessa Mar'li]]
        L["Encounter-200787"] = [[Signore del Sangue Mandokir]]
        L["Encounter-200788"] = [[Orlo della Follia]]
        L["Encounter-200789"] = [[Gran Sacerdote Thekal]]
        L["Encounter-200790"] = [[Gahz'ranka]]
        L["Encounter-200791"] = [[Gran Sacerdotessa Arlokk]]
        L["Encounter-200792"] = [[Jin'do il Malefico]]
        L["Encounter-200793"] = [[Hakkar]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
...
elseif locale == "koKO" then
    ...
    elseif Private.IsMists then
        ...
        L["Encounter-101565"] = [[토르토스]]
        L["Encounter-101578"] = [[메가이라]]
        L["Encounter-101573"] = [[지쿤]]
        L["Encounter-101572"] = [[잊혀진 두루무]]
        L["Encounter-101574"] = [[프리모디우스]]
        L["Encounter-101576"] = [[암흑 원령]]
        L["Encounter-101559"] = [[강철의 퀀]]
        L["Encounter-101560"] = [[쌍둥이 왕비]]
        L["Encounter-101579"] = [[레이 션]]
        L["Encounter-101580"] = [[라덴]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "10H회 처치 후 로그 점수 표시"
        L["Encounter-100629"] = [[노스렌드 야수]]
        L["Encounter-100633"] = [[군주 자락서스]]
        L["Encounter-100637"] = [[진영 대표 용사]]
        L["Encounter-100641"] = [[발키르 쌍둥이]]
        L["Encounter-100645"] = [[아눕아락]]
        L["Encounter-200784"] = [[대사제 베녹시스]]
        L["Encounter-200785"] = [[대여사제 제클릭]]
        L["Encounter-200786"] = [[대여사제 말리]]
        L["Encounter-200787"] = [[혈군주 만도키르]]
        L["Encounter-200788"] = [[광란의 경계]]
        L["Encounter-200789"] = [[대사제 데칼]]
        L["Encounter-200790"] = [[가즈란카]]
        L["Encounter-200791"] = [[대여사제 알로크]]
        L["Encounter-200792"] = [[사술사 진도]]
        L["Encounter-200793"] = [[학카르]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "10H회 처치 후 로그 점수 표시"
...
elseif locale == "ptBR" then
    ...
    elseif Private.IsMists then
        ...
        L["Encounter-51580"] = [[Ra-den]]
        L["addon.parse-gate-description"] = "Análises apresentadas após: mortes por limiar "
        L["Encounter-101577"] = [[Jin'rokh, o Rebentador]]
        L["Encounter-101575"] = [[Horridon]]
        L["Encounter-101570"] = [[Conselho dos Anciãos]]
        L["Encounter-101565"] = [[Tórtus]]
        L["Encounter-101578"] = [[Megaira]]
        L["Encounter-101573"] = [[Ji-Kun]]
        L["Encounter-101572"] = [[Durumu, o Esquecido]]
        L["Encounter-101574"] = [[Primordius]]
        L["Encounter-101576"] = [[Animus Sombrio]]
        L["Encounter-101559"] = [[Qon de Ferro]]
        L["Encounter-101560"] = [[Empíreas Gêmeas]]
        L["Encounter-101579"] = [[Lei Shen]]
        L["Encounter-101580"] = [[Ra-den]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "Análises apresentadas após: mortes por limiar "
        L["Encounter-100629"] = [[Feras de Nortúndria]]
        L["Encounter-100633"] = [[Lorde Jaraxxus]]
        L["Encounter-100637"] = [[Campeões das Facções]]
        L["Encounter-100641"] = [[Gêmeas Val'kyr]]
        L["Encounter-100645"] = [[Anub'arak]]
        L["Encounter-200784"] = [[Sumo Sacerdote Venoxis]]
        L["Encounter-200785"] = [[Alta-sacerdotisa Jeklik]]
        L["Encounter-200786"] = [[Alta-sacerdotisa Mar'li]]
        L["Encounter-200787"] = [[Sangrelorde Mandokir]]
        L["Encounter-200788"] = [[Beira da Loucura]]
        L["Encounter-200789"] = [[Sumo Sacerdote Thekal]]
        L["Encounter-200790"] = [[Gahz'ranka]]
        L["Encounter-200791"] = [[Alta-sacerdotisa Arlokk]]
        L["Encounter-200792"] = [[Jin'do, o Bagateiro]]
        L["Encounter-200793"] = [[Hakkar]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "Análises apresentadas após: mortes por limiar "
...
elseif locale == "ruRU" then
    ...
    elseif Private.IsMists then
        ...
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-101577"] = [[Джин'рок Разрушитель]]
        L["Encounter-101575"] = [[Хорридон]]
        L["Encounter-101570"] = [[Совет старейшин]]
        L["Encounter-101565"] = [[Тортос]]
        L["Encounter-101578"] = [[Мегера]]
        L["Encounter-101573"] = [[Цзи-Кунь]]
        L["Encounter-101572"] = [[Дуруму Позабытый]]
        L["Encounter-101574"] = [[Изначалий]]
        L["Encounter-101576"] = [[Темный Анимус]]
        L["Encounter-101559"] = [[Кон Железный]]
        L["Encounter-101560"] = [[Небесные сестры]]
        L["Encounter-101579"] = [[Лэй Шэнь]]
        L["Encounter-101580"] = [[Ра-ден]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
        L["Encounter-100629"] = [[Чудовища Нордскола]]
        L["Encounter-100633"] = [[Лорд Джараксус]]
        L["Encounter-100637"] = [[Чемпионы фракций]]
        L["Encounter-100641"] = [[Валь'киры-близнецы]]
        L["Encounter-100645"] = [[Ануб'арак]]
        L["Encounter-200784"] = [[Верховный жрец Веноксис]]
        L["Encounter-200785"] = [[Верховная жрица Джеклик]]
        L["Encounter-200786"] = [[Верховная жрица Мар'ли]]
        L["Encounter-200787"] = [[Мандокир Повелитель Крови]]
        L["Encounter-200788"] = [[Грань Безумия]]
        L["Encounter-200789"] = [[Верховный жрец Текал]]
        L["Encounter-200790"] = [[Газ'ранка]]
        L["Encounter-200791"] = [[Верховная жрица Арлокк]]
        L["Encounter-200792"] = [[Проклинатель Джин'до]]
        L["Encounter-200793"] = [[Хаккар]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "Parses shown after 10H kills"
...
elseif locale == "zhCN" then
    ...
    elseif Private.IsMists then
        ...
        L["addon.parse-gate-description"] = "分数在 10H 击杀后显示"
        L["Encounter-101577"] = [[击碎者金罗克]]
        L["Encounter-101575"] = [[赫利东]]
        L["Encounter-101570"] = [[长者议会]]
        L["Encounter-101565"] = [[托多斯]]
        L["Encounter-101578"] = [[墨格瑞拉]]
        L["Encounter-101573"] = [[季鹍]]
        L["Encounter-101572"] = [[遗忘者杜鲁姆]]
        L["Encounter-101574"] = [[普利莫修斯]]
        L["Encounter-101576"] = [[黑暗意志]]
        L["Encounter-101559"] = [[铁穹]]
        L["Encounter-101560"] = [[神女双天]]
        L["Encounter-101579"] = [[雷神]]
        L["Encounter-101580"] = [[莱登]]
    elseif Private.IsClassicEra and C_Seasons.GetActiveSeason() == Enum.SeasonID.SeasonOfDiscovery then
        L["addon.parse-gate-description"] = ""
    ...
    elseif C_Seasons.GetActiveSeason() == 109 then
        L["addon.parse-gate-description"] = "分数在 10H 击杀后显示"
        L["Encounter-100629"] = [[诺森德猛兽]]
        L["Encounter-100633"] = [[加拉克苏斯大王]]
        L["Encounter-100637"] = [[阵营冠军]]
        L["Encounter-100641"] = [[瓦格里双子]]
        L["Encounter-100645"] = [[阿努巴拉克]]
        L["Encounter-200784"] = [[高阶祭司温诺希斯]]
        L["Encounter-200785"] = [[高阶祭司耶克里克]]
        L["Encounter-200786"] = [[高阶祭司玛尔里]]
        L["Encounter-200787"] = [[血领主曼多基尔]]
        L["Encounter-200788"] = [[疯狂之缘]]
        L["Encounter-200789"] = [[高阶祭司塞卡尔]]
        L["Encounter-200790"] = [[加兹兰卡]]
        L["Encounter-200791"] = [[高阶祭司娅尔罗]]
        L["Encounter-200792"] = [[妖术师金度]]
        L["Encounter-200793"] = [[哈卡]]
    elseif Private.IsClassicEra and (C_Seasons.GetActiveSeason() == Enum.SeasonID.Fresh or C_Seasons.GetActiveSeason() == 125) then
        L["addon.parse-gate-description"] = "分数在 10H 击杀后显示"
