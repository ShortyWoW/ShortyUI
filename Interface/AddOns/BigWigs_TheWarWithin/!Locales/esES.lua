...
L = BigWigs:NewBossLocale("Reshanor, The Untethered", "esES")
if L then
	L.run = "Corre al portal y clica el botón de acción extra"
end
...
L = BigWigs:NewBossLocale("Plexus Sentinel", "esES")
if L then
	--L.cleanse_the_chamber = "Wall"
end

L = BigWigs:NewBossLocale("Loom'ithar", "esES")
if L then
...
L = BigWigs:NewBossLocale("Ulgrax the Devourer", "esES")
if L then
...
if L then
	...
	L.volatile_concoction_explosion_desc = "Muestra una barra para el jugador seleccionado por el Brebaje Volátil."
end
