...
L = BigWigs:NewBossLocale("Reshanor, The Untethered", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Plexus Sentinel", "ptBR")
if L then
	--L.cleanse_the_chamber = "Wall"
end

L = BigWigs:NewBossLocale("Loom'ithar", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Ulgrax the Devourer", "ptBR")
if L then
